...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-body">
            ...
            <p>Cảm ơn bạn đã liên hệ với chúng tôi. Chúng tôi đã nhận được thông tin của bạn và sẽ phản hồi sớm nhất có thể.</p>

            <p>Dưới đây là chi tiết thông tin bạn đã gửi:</p>

            <p class="info-row"><strong>Họ tên:</strong> {{ $data['name'] }}</p>
            <p class="info-row"><strong>Email:</strong> <a href="mailto:{{ $data['email'] }}">{{ $data['email'] }}</a></p>
